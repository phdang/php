...
<div id="wrapper_sec">
					...
					?>
                        ...
                        <li class="dir"><span class="colr navihead bold"><?php echo $d1['name'];?></span>
							...
							?>
                                ...
                                <li><a href="listing.php?cid=<?php echo $d2['id'];?>"><?php echo $d2['name'];?></a></li>
                             <?php }?>    
                            </ul>
                        </li>
                     <?php }?>  
    ...
    <div class="content_sec">
        ...
        <div class="col2">
		  ...
		  ?>      
                    <li>
                    	<a href="detail.php?idsp=<?php echo $d3['id'];?>"><img src="images/sanpham/<?php echo $d3['img_url'];?>" alt="" ></a>
		...
		?>        	
                    ...
                    <li <?php if($i%4==0) echo 'class="last"';?> >
                    	<a href="detail.php?idsp=<?php echo $d4['id'];?>" class="thumb"><img src="images/sanpham/<?php echo $d4['img_url'];?>" alt="" ></a>

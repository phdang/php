        ...
        <div class="col2">
            ...
            <div class="sorting">
                ...
                <ul class="right">                	
					...
					if($i >= 1 && $i <= $tst){
					?>
                        <a href="?page=<?php echo $i;?>&cid=<?php echo $cid;?>&sort=<?=$sort?>" class="colr <?php if($i==$page) echo 'current' ?>"><?php echo $i;?></a> 
                    <?php }?>                           
                    </li>
                </ul>
                <div class="clear"></div>
                ...
                <ul class="right">
                	<li class="text">
                    	Sort by Position
                    	<a href="?page=1&cid=<?php echo $cid;?>&sort=<?=($sort==3)?4:3;?>" class="colr <?php if($sort > 2) echo 'current' ?>">Name <?php if($sort==4) echo '<img src="images/desc.png" alt="asc sort">'; if($sort==3) echo '<img src="images/asc.png" alt="asc sort">' ?></a> | 
                        <a href="?page=1&cid=<?php echo $cid;?>&sort=<?=($sort==1)?2:1;?>" class="colr <?php if($sort <= 2) echo 'current' ?>">Price <?php if($sort==2) echo '<img src="images/desc.png" alt="asc sort">'; if($sort==1) echo '<img src="images/asc.png" alt="asc sort">' ?></a> 
                    </li>
                </ul>
          	</div>
            <div class="listing">
			   ...
			   ?> 	
                    <li <?php if($i%4==0) echo 'class="last"'; $i++;?>>
                    	<a href="detail.html" class="thumb"><img src="images/sanpham/<?php echo $dsp['img_url'];?>" alt="" ></a>

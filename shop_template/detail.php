							...
							<li class="dir"><a href="#">Pages</a>
									<ul class="bordergr small">
											<li class="dir"><span class="colr navihead bold">Pages</span>
													<ul>
															<li class="clear"><a href="index.php">Trang chủ Page</a></li>
    ...
    <div class="crumb">
    	<ul>
            ...
            <?php
						...
						$rs = mysqli_query($link,$sql);
						$r = mysqli_fetch_assoc($rs);
						$sql = "SELECT dep.`name`, cat.`id` FROM `nn_department` AS dep, `nn_category` AS cat, `nn_product` AS pro WHERE pro.`category_id` = cat.id AND cat.`department_id` = dep.id AND {$r['id']} = pro.id";
						mysqli_set_charset($link,'utf8');
						$rs = mysqli_query($link,$sql);
						$r = mysqli_fetch_assoc($rs);
			?>
...
<!-- Footer Section -->
	<div id="footer">
        ...
        <div class="foot_top">
            ...
            <div class="botm_navi">
            	<ul>
                	<li><a href="index.php">Trang chủ page</a></li>

    ...
    <div class="big_thumb">
        <div id="slider2">
            ...
            <div class="contentdiv">
                <img style="width: auto !important" src="images/sanpham/<?php echo $dsp['img_url'];?>" alt="" >
                <a rel="example_group" href="images/sanpham/<?php echo $dsp['img_url'];?>" title="<?= $dsp['name'] ?>" class="zoom">&nbsp;</a>
          </div>

				...
				<div class="media">
					<div class="media-heading">
						...
						<div class="time">
							...
							<time datetime="<?php echo comment_date('c'); ?>"><?php printf(__('%1$s', 'shoppystore'), get_comment_date(),  get_comment_time()); ?></time>
						</div>
					</div>
...
<div id="respond">
<h2><?php esc_html_e('Submit a Review', 'shoppystore'); ?></h2>
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform" name="commentform" onsubmit="return submitform()" class="form-horizontal row-fluid">		
		...
		<div class="control-group">			
			...
			<button type="submit" class="btn btn-default">
				<i class="fa fa-comment-o"></i><?php esc_html_e('Post comment', 'shoppystore'); ?>
			</button>
		</div>
        </div>

	...
	function render(){
		...
		echo '<fieldset>';
			...
			foreach($this->field['options'] as $k => $v){
				...
				echo '<img src="'.$v['img'].'" alt="'.$v['title'].'" title="'.esc_attr( $v['title'] ).'" onclick="jQuery:ya_radio_img_select(\''.$this->field['id'].'_'.array_search($k,array_keys($this->field['options'])).'\', \''.$this->field['id'].'\');" />';

...
<p>
	<label for="<?php echo $this->get_field_id('categories'); ?>"><?php esc_html_e('Categories Name', 'shoppystore')?></label>
	<br />
...
<p>
	<label for="<?php echo $this->get_field_id('number'); ?>"><?php esc_html_e('Number of Categories', 'shoppystore')?></label>
	<br />
	<input class="widefat"
...
<p>
	<label for="<?php echo $this->get_field_id('exclude'); ?>"><?php esc_html_e('Exclude', 'shoppystore')?></label>
	<br />
	<input class="widefat"

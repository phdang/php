...
<p>
	<label for="<?php echo $this->get_field_id('category'); ?>"><?php esc_html_e('Category Name', 'shoppystore')?></label>
	<br />
...
<p>
	<label for="<?php echo $this->get_field_id('include'); ?>"><?php esc_html_e('Include Posts ID', 'shoppystore')?></label>
	<br />
	<input class="widefat"
...
<p>
	<label for="<?php echo $this->get_field_id('exclude'); ?>"><?php esc_html_e('Exclude Posts ID', 'shoppystore')?></label>
	<br />
	<input class="widefat"
...
<p>
	<label for="<?php echo $this->get_field_id('length'); ?>"><?php esc_html_e('Excerpt length (in words): ', 'shoppystore')?></label>
	<br />
	<input class="widefat"

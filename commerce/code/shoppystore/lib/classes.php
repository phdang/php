...
abstract class YA_Widget extends WP_Widget{
	...
	public function widget_template_select( $field_name, $opts = array(), $field_value = null ){
		...
		if ( array_key_exists('ov', $templates) && count($templates['ov']) ){
			$select_html .= '<optgroup label="'. esc_html__('Override by Theme', 'shoppystore') .'">';
		...
		if ( array_key_exists('df', $templates) && count($templates['df']) ){
			$select_html .= '<optgroup label="'. esc_html__('Default Template', 'shoppystore') .'">';
	...
	public function form( $instance ){
		...
		?>
		<p>
			<label for="<?php echo $this->get_field_id('title'); ?>"><?php esc_html_e('Title', 'shoppystore')?></label>
			<br />
			<input class="widefat"
		...
		<p>
			<label for="<?php echo $this->get_field_id('widget_template'); ?>"><?php esc_html_e("Template", 'shoppystore')?></label>
			<br/>
